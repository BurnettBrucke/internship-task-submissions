def find_largest_smallest():
    ...
    for i in range(len(list1)):
        ...
        if list1[i]<smallest:
            smallest=list1[i]
    print(f"Largest of the list is : {largest} and smallest of the list is : {smallest}")
...
def marks_high_low_average():
    ...
    print(f"Highest Scorer: {highest_scorer} marks of highest scorer {marks[highest_scorer]}")
    print(f"lowest Scorer : {lowest_scorer} marks of lowest scorer {marks[lowest_scorer]}")
